...
function result() {
	...
	*/
	...
	/* STEP 9: Replace the three placeholders in the newStory string — :insertx:, :inserty:, and :insertz: — with the strings stored in xItem, yItem, and zItem.
	 //You might have to use the replace() method twice, because there are 2 instances of :insertx: in the story */
...
/* STEP 5: Add a click event listener to the "Generate random story" button (represented by the const randomize in STEP 1).
//When the button it represents is clicked, make sure that the result() function is invoked. */
